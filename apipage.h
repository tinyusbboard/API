 ...
 * BLS API page, usually located in the bootloader
...
/* platform identification - can be defined externally - tinyUSBboard / AVRStick is default */
#ifndef USE_SPMINTEREFACE_MAGICVALUE
#if (F_CPU == 16000000)
/* ATmega architectures @ 16MHz: tinyUSBboard */
#	if defined (__AVR_ATmega8__) || defined (__AVR_ATmega8A__) || defined (__AVR_ATmega8HVA__)
#		define USE_SPMINTEREFACE_MAGICVALUE	(0xfe9a5680)
#	elif defined (__AVR_ATmega328P__)
#		define USE_SPMINTEREFACE_MAGICVALUE	(0xfe9a5680)
/* secondary supported ATmegas */
#	elif defined (__AVR_ATmega88__) || defined (__AVR_ATmega88P__)
#		define USE_SPMINTEREFACE_MAGICVALUE	(0xfe9a5682)
#	elif defined (__AVR_ATmega168__) || defined (__AVR_ATmega168P__)
#		define USE_SPMINTEREFACE_MAGICVALUE	(0xfe9a5683)
#	elif defined (__AVR_ATmega328__)
#		define USE_SPMINTEREFACE_MAGICVALUE	(0xfe6a5984)
#	else
/* unknown */
#		warning unkown magic value, please define USE_SPMINTEREFACE_MAGICVALUE
#		define USE_SPMINTEREFACE_MAGICVALUE	(0xFFFFFFFF)
#	endif
#elif (F_CPU == 32000000)
/* XMEGA architectures @ 32MHz: AVRStick */
...
/* don't export anything directly from spminterface to others than apipage.c */
#		define HAVE_SPMINTEREFACE_MAGICVALUE (USE_SPMINTEREFACE_MAGICVALUE)
#		include "spminterface.h"
#	endif
...
#		define BOOT_SECTION_START		((funcaddr___bootloader__do_spm) - (_VECTORS_SIZE))
#	endif

#	ifndef BOOT_SECTION_SIZE
#		define BOOT_SECTION_SIZE		((PROGMEM_SIZE) - (BOOT_SECTION_START))
#	endif

#	ifndef BOOT_SECTION_PAGE_SIZE
#		define BOOT_SECTION_PAGE_SIZE		(SPM_PAGESIZE)
#	endif
#endif


/* general addressing makros - not used when spminterface */
...
/* specific API functions - not used when spminterface */
 ...
 */
APIPAGEPUBLIC int flash_comparepage(const uint8_t in_pageBuffer[SPM_PAGESIZE], const uint_farptr_t in_pageNr) APIPAGEAUXSECTION;
